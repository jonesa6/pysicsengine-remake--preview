...
namespace Physics_ {
    ...
    */
    export class ModdedSpriteMap_ {
         ...
         */
        neighbors(sprite: Sprite_): Sprite_[] {
            const n: Sprite_[] = [];
            const layer = 0
        ...
        //private checkfor() {}
        private insertAtKey(x: number, y: number, sprite: Sprite_) {
        ...
        private mergeAtKey(x: number, y: number, layer: number, n: Sprite_[]) {
            const k = this.key(x, y);
